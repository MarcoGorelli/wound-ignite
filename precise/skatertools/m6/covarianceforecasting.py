...
def m6_data(interval='d', n_dim=100, n_obs=300, last_date=None, cache_path=None):
    tickers = np.array([['ABBV', 'ACN', 'AEP', 'AIZ', 'ALLE'], ['AMAT', 'AMP', 'AMZN', 'AVB', 'AVY'], ['AXP', 'BDX', 'BF-B', 'BMY', 'BR'], ['CARR', 'CDW', 'CE', 'CHTR', 'CNC'], ['CNP', 'COP', 'CTAS', 'CZR', 'DG'], ['DPZ', 'PLD', 'DXC', 'EWA', 'EWC'], ['EWG', 'EWH', 'EWJ', 'EWL', 'EWQ'], ['EWT', 'EWU', 'EWY', 'EWZ', 'FTV'], ['GOOG', 'GPC', 'GSG', 'HIG', 'HIGH.L'], ['HST', 'HYG', 'IAU', 'ICLN', 'IEAA.L'], ['IEF', 'IEFM.L', 'IEMG', 'IEUS', 'IEVL.L'], ['IGF', 'INDA', 'IUMO.L', 'IUVL.L', 'IVV'], ['IWM', 'IXN', 'JPEA.L', 'JPM', 'KR'], ['LQD', 'MCHI', 'META', 'MVEU.L', 'OGN'], ['PG', 'PPL', 'PRU', 'PYPL', 'RE'], ['REET', 'ROL', 'ROST', 'SEGA.L', 'SHY'], ['SLV', 'SPMV.L', 'TLT', 'UNH', 'URI'], ['V', 'VRSK', 'VXX', 'WRK', 'XLB'], ['XLC', 'XLE', 'XLF', 'XLI', 'XLK'], ['XLP', 'XLU', 'XLV', 'XLY', 'XOM']]).flatten()
